...
public class SnowflakeIdGenerator2 {
	...
	// ================================================Algorithm's
	// Parameter=============================================
	// 系统开始时间截 (UTC 2019-08-23 10:41:00)
	private final long startTime = 1566528061188L;
	// 机器id所占的位数
	...
	public synchronized long nextId() {
		...
		return ((timestamp - startTime) << timestampMoveBits) | (dataCenterId << dataCenterIdMoveBits)
				| (workerId << workerIdMoveBits) | sequence;
	}
